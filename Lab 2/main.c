...
void EXTI0_1_IRQHandler(void) {
    // Toggle green LED (PC9)
    HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_9);
    
    // Toggle orange LED (PC8)
    ...
    // Toggle green LED again (PC9)
    //HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_9);

    // Toggle orange LED again (PC8)
    //HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_8);
		
    // Clear the EXTI interrupt flag if needed
...
int main(void)
{
  ...
  NVIC_SetPriority(EXTI0_1_IRQn, 1); //set EXTI0_1 to prioirty 3 in part 2
													
	//NVIC_SetPriority(SysTick_IRQn, 2);//part 2
